...
from prepare_data.prepare_raw.get_origin_data_movielen import Get_movie_data
...
if __name__ == '__main__':
    ...
    if data_name == 'fs':
        ...
        origin_data_model = Get_movie_data(init_origin_data)
    elif data_name == 'elec':
        origin_data_model = Get_amazon_data_elec(init_origin_data)
